...
def bbox_loss(pred_box, true_box, margin=None, log_output=False, area_encoding=False):
    ...
    return iou_loss + reg_loss*10 + pair_loss
...
def obj_bbox_loss(pred_box, true_box):
